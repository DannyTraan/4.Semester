...
GO
PRINT N'Creating [dbo].[fk_Person2]...';


GO
ALTER TABLE [dbo].[Person] WITH NOCHECK
    ADD CONSTRAINT [fk_Person2] FOREIGN KEY ([_NoteID]) REFERENCES [dbo].[Noter] ([_NoteID]) ON UPDATE CASCADE;


GO
PRINT N'Creating [dbo].[fk_Person3]...';


GO
ALTER TABLE [dbo].[Person] WITH NOCHECK
    ADD CONSTRAINT [fk_Person3] FOREIGN KEY ([_TelefonID]) REFERENCES [dbo].[Telefon] ([_TelefonID]) ON UPDATE CASCADE;


GO
PRINT N'Creating [dbo].[fk_Person4]...';


GO
ALTER TABLE [dbo].[Person] WITH NOCHECK
    ADD CONSTRAINT [fk_Person4] FOREIGN KEY ([_EmailID]) REFERENCES [dbo].[Email] ([_EmailID]) ON UPDATE CASCADE;
...
ALTER TABLE [dbo].[Person] WITH CHECK CHECK CONSTRAINT [fk_Person2];

ALTER TABLE [dbo].[Person] WITH CHECK CHECK CONSTRAINT [fk_Person3];

ALTER TABLE [dbo].[Person] WITH CHECK CHECK CONSTRAINT [fk_Person4];
